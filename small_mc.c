...
double mu_a = 0.001;			/* Absorption Coefficient in 1/cm */
double mu_s = 10;			/* Scattering Coefficient in 1/cm */
double g = 0.6;				/* Scattering Anisotropy -1<=g<=1 */
double n = 1.5;				/* Index of refraction of medium */
double microns_per_bin = 100;/* Thickness of one bin layer */
long   i, photons = 1000;
